    ...
    <html>
    <head>
    <title>Candidate: distant_s13_y2</title>
    <link href ="style_content.css" type="text/css" rel="stylesheet">
    </head>
    <body>
        <div class = "main">
            <div class = "header">
                <h1> Candidate: distant_s13_y2</h1>
...
?>
			...
			<table ID="t02" >
				<tr>
					<td align="center" colspan="5"><b>Images of distant_s13_y2</b>
...
<form action = "" method = "POST">
    ...
    <input type = "submit" value = "Post!"><br/>
			...
			<table ID="t02" >
				<tr>
					<td align="center" colspan="5"><b>Exposures coinciding with best fit orbit of distant_s13_y2</b>
					<p> Click on an image to expand it. </p>
					</td>
                </tr>
